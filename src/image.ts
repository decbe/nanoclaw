...
/**
 * Process an image buffer: resize, convert to JPEG, and save to disk.
 * Returns the content string with image reference and the relative path.
 */
 ...
 * Returns an array of image attachments with relative paths and media types.
 */
